...
export function AlgorithmHistoryPage() {
  ...
  return (
    <div className="page-stack algorithm-history-page">
      <header className="page-header"><div><span className="page-kicker">算法训练</span><h1>训练历史</h1></div><p>每一次尝试会保留独立记录，方便比较思路、用时和复习结果。</p></header>
