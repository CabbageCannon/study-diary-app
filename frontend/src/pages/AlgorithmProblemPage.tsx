...
export function AlgorithmProblemPage() {
  ...
  const backLink = <Link className="back-link" to="/algorithms/history"><ArrowLeftIcon aria-hidden="true" size={17} />训练历史</Link>;
